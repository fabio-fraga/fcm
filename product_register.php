...
stmt(
    prepare:"
        INSERT INTO FCM_PRODUTOS (PRO_NOME, PRO_VALOR, PRO_QUANTIDADE_DISPONIVEL, PRO_CAT_CODIGO, PRO_DESCRICAO, PRO_CMT_CODIGO)
        VALUES (?, ?, ?, ?, ?, ?)
    ",
    execute_array: [$name, $price, $amount, $category, $description, $_SESSION["user_id"]]
);
